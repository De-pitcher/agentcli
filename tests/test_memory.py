...
class TestCalculateCost:
    ...
    def test_calculate_cost_paid_models(self) -> None:
        ...
        cost_sonnet = calculate_cost(
            "anthropic/claude-3.5-sonnet", prompt_tokens=100_000, completion_tokens=50_000
        )
    ...
    def test_calculate_cost_unknown_model_fallback(self) -> None:
        cost_unknown = calculate_cost(
            "custom/unknown-model", prompt_tokens=1_000_000, completion_tokens=1_000_000
        )
